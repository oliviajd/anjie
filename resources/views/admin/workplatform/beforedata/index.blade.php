                ...
                <div class="box-body">
                  ...
                  <div class="row margin-bottom">
                            ...
                            <div class="col-xs-3">
                                <div class="input-group">
                                    ...
                                    <select name="current_item_id" class="form-control current_item_id">
                                        <option value="">请选择</option>
                                        <option value="|2|">经销商申请按揭</option>
                                        <option value="|3|">银行驻点人员查询征信</option>
                                        <option value="|7|">家访签约</option>
                                        <option value="|8|">录入员录入档案</option>
                                        <option value="|9|">人工审批（一审）</option>
                                        <option value="|13|">补充资料</option>
                                        <option value="|37|">人工审批（二审）</option>
                                        <option value="|38|">补充资料</option>
                                        <option value="|39|">财务打款</option>
                                        <option value="|40|">回款确认</option>
                                        <option value="|41|">寄件登记</option>
                                        <option value="|42|">抄单登记</option>
                                        <option value="|43|">车辆GPS登记</option>
                        ...
                        <div class="row margin-bottom">
                            ...
                            <!-- <button type="button" class="btn btn-default taskquery_more" value= "2">进阶查询</button> -->
                        </div>
                    </div>
...
<script src="/bower_components/AdminLTE/plugins/daterangepicker/daterangepicker.js"></script>
 <script type="text/javascript">
    ...
    var task_deal = function (id) {
        window.location.href = '/Admin/work/detailbeforedata?id=' + id ;
    }
    $(document).ready(function(){
        ...
        var table = $("#example1").DataTable({
            ...
            "ajax": {
                'url':"/Api/workplatform/beforedata",
                'data': {
