                ...
                <table id="example2" class="table table-bordered table-hover" style="font-size: 12px;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>打款日期</td>
                            <td><input type="text" name="finance_date" class="form-control" placeholder=""  id="finance_date" disabled="disabled"></td>
                        </tr>
                        <tr>
                            <td>★审核结果</td>
                            <td colspan="3">
                                <select name="moneyaudit_status" class="form-control">
    ...
    var task_deal = function (id, item_instance_id) {
        ...
        $('#assign_confirm').click(function () {
            ...
            var data = {
                ...
                'token':token,
                'moneyaudit_status' : $('select[name=moneyaudit_status]').val(),
            };
            $.ajax({
                url: '/Api/workplatform/moneyaudit',
                type: 'post',
                data: data,
                dataType: 'json',
                'success': function (r) {
