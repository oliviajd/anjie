...
<div class="content-wrappers">
  ...
  <!--   <section class="content-header">
        <h1>
            人工审批（一审人员）
            <small>artificial one</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="/Admin"><i class="fa fa-dashboard"></i> 首页</a></li>
            <li><a href="/Admin/work/artificialone">人工审批（一审人员）</a></li>
            <li class="active">人工审批（一审人员）</li>
        </ol>
    </section> -->
</div><br/>
...
<script type="text/javascript">
    ...
    var task_deal = function (id,item_instance_id) {
        window.location.href = '/Admin/work/detailartificialone?id=' + id + '&item_instance_id=' + item_instance_id;
    }
    start_time ='';
    end_time ='';
