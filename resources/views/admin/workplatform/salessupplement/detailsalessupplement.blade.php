    ...
    $(function () {
        ...
        $('#first_pay, #car_price').change(function(){ 
            ...
            if (first_pay.length > 0 && car_price.length > 0) {
                var first_pay_ratio = (first_pay/car_price) * 100 + '%';
        ...
        $('#submit button').click(function () {
            if ($(this).attr('data-status') !== '2') {
                if (checkempty('hukou,customer_marital_status,customer_has_bondsman,loan_prize,loan_date,first_pay_ratio,loan_rate,car_brand,car_type,car_vehicle_identification_number,car_price,has_insurance') == false) {
                    var modal = $('#myModal');
                ...
                //     if (checknum('commercial_insurance,compulsory_insurance,vehicle_vessel_tax,gross_premium') == false) {
                //         var modal = $('#myModal');
            ...
            $.ajax({
                url: '/Api/workplatform/salessupplement',
                type:'post',
                data: data,
                dataType: 'json',
                'success': function (r) {
                    ...
                    if (r.error_no == '200') {
                        $('.modal_close').click(function () {
                            window.location.href = '/Admin/work/salessupplement';
                        });
                    }
                },
                'error': function (r) {
