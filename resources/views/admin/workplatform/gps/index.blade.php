    ...
    <div class="modal-dialog" role="document">  
        <div class="modal-content">  
            <div class="modal-header">  
                ...
                <h4 class="modal-title" id="myModalLabel">GPS登记</h4>  
            </div>  
            <div class="modal-body"> 
                <table id="example2" class="table table-bordered table-hover" style="font-size: 12px;">
                    <tbody>
                        ...
                        <tr>
                            <td>GPS编号1</td>
                            <td><input type="text" name="gps_number" class="form-control gps_number" placeholder=""></td>
                            <td>GPS编号2</td>
                            <td><input type="text" name="gps_number2" class="form-control gps_number2" placeholder=""></td>
                        </tr>
                        <tr>
                            <td>★安装位置</td>
                            <td><input type="text" name="install_position" class="form-control install_position" placeholder=""></td>
                            <td>★安装日期</td>
                            <td><input type="text" id="install_time" name="install_time" class="form-control pull-right install_time"></td>
                        </tr>
                        <tr>
                            <td>备注</td>
                            <td colspan="3"><textarea name="gps_description" class="comments" cols="75" rows="4" placeholder=""></textarea></td>
                        </tr>
                    </tbody>   
                </table> 
            </div>  
...
<script type="text/javascript">
    ...
    var task_deal = function (id, item_instance_id) {
        ...
        $('#assign_confirm').click(function () {
            if (checkempty('install_position,install_time') == false) {
                var modal = $('#myModal');
                modal.find('.modal-body').text('信息填写不完整');
                modal.modal('show');
                return false;
            }
            if ($("[name=gps_number]").val() == '' && $("[name=gps_number2]").val() == '') {
                var modal = $('#myModal');
                modal.find('.modal-body').text('GPS编号至少需填写一个');
                modal.modal('show');
                return false;
            }
            var _this = this;
            ...
            var data = {
                ...
                'token': token,
                'gps_number': $("[name=gps_number]").val(),
                'gps_number2': $("[name=gps_number2]").val(),
                'install_position': $("[name=install_position]").val(),
                'install_time': $("[name=install_time]").val(),
                'gps_description': $("[name=gps_description]").val(),
            };
            $.ajax({
                url: '/Api/workplatform/gps',
                type: 'post',
                data: data,
                dataType: 'json',
                'success': function (r) {
    ...
    $(function () {
        ...
        $('#install_time').daterangepicker({singleDatePicker: true, timePickerIncrement: 30, format: 'MM/DD/YYYY h:mm A'});
