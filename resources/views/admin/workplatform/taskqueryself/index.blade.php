...
<script src="/bower_components/AdminLTE/plugins/daterangepicker/daterangepicker.js"></script>
 <script type="text/javascript">
    ...
    var task_deal = function (id) {
        window.location.href = '/Admin/work/detailtaskqueryself?id=' + id ;
    }
    $(document).ready(function(){
    	...
    	$('#reservationtime').daterangepicker({showDropdowns:true,timePicker24Hour:true,startDate:oStartDate,endDate:oEndDate,timePicker: true, timePickerIncrement: 1, format: 'MM/DD/YYYY h:mm A'});
        ...
        var table = $("#example1").DataTable({
            ...
            "ajax": {
                'url':"/Api/workplatform/taskqueryself",
                'data': {
