    ...
    <div class="modal-dialog" role="document">  
        <div class="modal-content">  
            <div class="modal-header">  
                ...
                <h4 class="modal-title" id="myModalLabel">寄件登记</h4>  
            </div>  
            <div class="modal-body"> 
                <table id="example2" class="table table-bordered table-hover" style="font-size: 12px;">
                    <tbody>
                        ...
                        <tr>
                            <td>★寄件人</td>
                            <td><input type="text" name="courier_man" class="form-control courier_man" placeholder=""></td>
                            <td>★快递商</td>
                            <td><input type="text" name="courier_business" class="form-control courier_business" placeholder=""></td>
                        </tr>
                        <tr>
                            <td>★快递单号</td>
                            <td><input type="text" name="courier_number" class="form-control courier_number" placeholder=""></td>
                            <td>★寄件时间</td>
                            <td><input type="text" id="courier_time" name="courier_time" class="form-control pull-right courier_time" ></td>
                        </tr>
                        <tr>
                            <td>备注</td>
                            <td colspan="3"><textarea class="comments" name="courier_description" cols="75" rows="4" placeholder=""></textarea></td>
                        </tr>
                    </tbody>   
                </table> 
            </div>  
...
<script type="text/javascript">
    ...
    var task_deal = function (id, item_instance_id) {
        ...
        $('[name=courier_man]').val(row['courier_man'])
        $('[name=courier_business]').val(row['courier_business'])
        $('[name=courier_number]').val(row['courier_number'])
        $('[name=courier_time]').val(row['courier_time'])
        $('[name=courier_description]').val(row['courier_description'])
        $('#assign_confirm').unbind('click');
        $('#assign_confirm').click(function () {
            if (checkempty('courier_man,courier_business,courier_number,courier_time') == false) {
                var modal = $('#myModal');
            ...
            var data = {
                ...
                'token': token,
                'courier_man': $("[name=courier_man]").val(),
                'courier_business': $("[name=courier_business]").val(),
                'courier_number': $("[name=courier_number]").val(),
                'courier_time': $("[name=courier_time]").val(),
                'courier_description': $("[name=courier_description]").val(),
            };
            $.ajax({
                url: '/Api/workplatform/courier',
                type: 'post',
                data: data,
                dataType: 'json',
                'success': function (r) {
    ...
    $(function () {
        ...
        $('#courier_time').daterangepicker({singleDatePicker: true, timePickerIncrement: 30, format: 'MM/DD/YYYY h:mm A'});
