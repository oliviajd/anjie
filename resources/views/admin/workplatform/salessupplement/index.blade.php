        ...
        <div class="col-md-12">
            ...
            <div class="box-body">
                <!-- <div class="box-header">
                    ...
                    <button type="button" class="status btn btn-default handle_button" value= "1">待认领案件</button>
                </div> -->
                <div class="box-body">
...
<script type="text/javascript">
    ...
    var task_deal = function (id, item_instance_id) {
        window.location.href = '/Admin/work/detailsalessupplement?id=' + id + '&item_instance_id=' + item_instance_id;
    }
    start_time ='';
    end_time ='';
