        ...
        <div class="col-md-7">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    @include('common.pannel.work_info_artificialtwo_opinion')
...
<script>
    ...
    $(function () {
        ...
        $(".artificialtwo_status").change(function(){ 
            if ($(".artificialtwo_status").val() == '2' &&　$('.refuse2_div').hasClass('hide')) {
                $('.refuse2_div').removeClass("hide");
            }
            if ($(".artificialtwo_status").val() !== '2' &&　($('.refuse2_div').hasClass('hide') == false)) {
                $('.refuse2_div').addClass("hide");
            }
        });
        ...
        $('.cancel').click(function(){
            window.location.href = '/Admin/work/artificialtwo';
        });
        $('#submit button.submit').click(function () {
            $('#submit button').prop('disabled', true);
            var type = $(this).attr('data-type');
            var artificialtwo_refuse_reason = [];
            $('[name=artificialtwo_refuse_reason]:checked').each(function(){
                artificialtwo_refuse_reason.push($(this).val());
            });
            var artificial_status = $('[name=artificialtwo_status]').val();
            if (artificial_status == '2' && artificialtwo_refuse_reason.length == 0) {
                var modal = $('#myModal');
            ...
            if (artificial_status == '3' && $('[name=artificialtwo_description]').val() == '') {
                var modal = $('#myModal');
            ...
            var data = {
                ...
                type: type,
                artificial:2,//二审
                artificial_status:$('[name=artificialtwo_status]').val(),
                artificialtwo_refuse_reason:artificialtwo_refuse_reason.join(','),
                artificialtwo_description:$('[name=artificialtwo_description]').val()
            }
            $.ajax({
