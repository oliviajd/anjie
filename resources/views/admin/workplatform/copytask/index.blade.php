    ...
    <div class="modal-dialog" role="document">  
        <div class="modal-content">  
            <div class="modal-header">  
                ...
                <h4 class="modal-title" id="myModalLabel">抄单登记</h4>  
            </div>  
            <div class="modal-body"> 
                <table id="example2" class="table table-bordered table-hover" style="font-size: 12px;">
                    <tbody>
                        ...
                        <tr>
                            <td>★抄单人</td>
                            <td><input type="text" name="copytask_courier_man" class="form-control copytask_courier_man" placeholder=""></td>
                            <td>★抄单时间</td>
                            <td><input type="text" id="copytask_courier_time" name="copytask_courier_time" class="form-control pull-right copytask_courier_time" ></td>
                        </tr>
                       <!--  <tr>
                            <td>快递单号</td>
                            <td><input type="text" name="copytask_courier_number" class="form-control" placeholder=""></td>
                            <td>快递商</td>
                            <td><input type="text" name="copytask_courier_business" class="form-control" placeholder=""></td>
                        </tr> -->
                        <tr>
                            <td>备注</td>
                            <td colspan="3"><textarea name="copytask_courier_description" class="comments" cols="75" rows="4" placeholder=""></textarea></td>
                        </tr>
                    </tbody>   
                </table> 
            </div>  
...
<script type="text/javascript">
    ...
    var task_deal = function (id, item_instance_id) {
        ...
        $('[name=copytask_courier_man]').val(row['copytask_courier_man'])
        $('[name=copytask_courier_business]').val(row['copytask_courier_business'])
        $('[name=copytask_courier_number]').val(row['copytask_courier_number'])
        $('[name=copytask_courier_time]').val(row['copytask_courier_time'])
        $('[name=copytask_courier_description]').val(row['copytask_courier_description'])
        ...
        $('#assign_confirm').click(function () {
            if (checkempty('copytask_courier_man,copytask_courier_time') == false) {
                var modal = $('#myModal');
            ...
            var data = {
                ...
                'token': token,
                'copytask_courier_man': $("[name=copytask_courier_man]").val(),
                'copytask_courier_business': $("[name=copytask_courier_business]").val(),
                'copytask_courier_number': $("[name=copytask_courier_number]").val(),
                'copytask_courier_time': $("[name=copytask_courier_time]").val(),
                'copytask_courier_description': $("[name=copytask_courier_description]").val(),
            };
            $.ajax({
                url: '/Api/workplatform/copytask',
                type: 'post',
                data: data,
                dataType: 'json',
                'success': function (r) {
    ...
    $(function () {
        ...
        $('#copytask_courier_time').daterangepicker({singleDatePicker: true, timePickerIncrement: 30, format: 'MM/DD/YYYY h:mm A'});
